   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			@endif
            <div class="col-lg-12">
			 {!! Form::open(array('route' => 'product.store','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation')) !!}
				<div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="validation-code" class="form-control"  placeholder="Sku Code"   name="sku_code"  type="text" data-validation="[NOTEMPTY]" data-validation-message="Sku Code must not be empty!">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="form-control-label">Product Description</label>
                    <textarea class="summernote" rows="4" id="l15" name="product_description" placeholder="Product Description"></textarea>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-metatitle">Disclaimer <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <textarea  rows="4" class="form-control"  placeholder="Disclaimer"  data-validation="[NOTEMPTY]" data-validation-message="Disclaimer must not be empty!"  name="disclaimer"  type="text" ></textarea>
                        </div>
                    </div>
                     <div class="col-lg-6">
                        <div class="form-group">
