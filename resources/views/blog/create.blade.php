   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			@endif
            <div class="col-lg-12">
			 {!! Form::open(array('route' => 'blog.store','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')) !!}
				<div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-blogname">Blog Name  <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input id="validation-blogname" class="form-control"  placeholder="Blog Name"   name="blog_name"  type="text" data-validation="[NOTEMPTY]" data-validation-message="Blog Name must not be empty!">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
