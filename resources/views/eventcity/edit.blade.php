@section('title', 'Update Event City ')
@include('main')
...
<section class="card">
    ...
    <div class="card-body">
        <div class="row">
			...
			@endif
			 {!! Form::model($events, ['method' => 'PATCH', 'id'=>'form-validation', 'name'=>'form-validation', 'route' => ['eventcity.update', $events->event_city_id], 'enctype'=>'multipart/form-data']) !!}
				<div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input id="validation-event" class="form-control" style="height:40px !important" value="{{$events->event_city }}"  placeholder="Event City"   name="event_city"  type="text" data-validation="[NOTEMPTY]" data-validation-message="Event City must not be empty!">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="event_place" value="{{$events->event_place }}" placeholder="Event Place" data-validation="[NOTEMPTY]" data-validation-message="Event Place must not be empty!">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <label class="form-control-label" style="margin-top:8px;">Event Address</label>
                        <textarea class="form-control" rows="4"  name="event_address" placeholder="Event Address">{{$events->event_address }}</textarea>
                    </div>
                </div>        
