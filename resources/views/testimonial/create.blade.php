   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			@endif
            <div class="col-lg-12">
			 {!! Form::open(array('route' => 'testimonial.store','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')) !!}
				<div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input  class="form-control"  placeholder="Company Name"   name="compnay_name"  type="text" >
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="4" id="l15" name="description" data-validation="[NOTEMPTY]" data-validation-message="Description must not be empty!" placeholder="Write a Description"></textarea>
                        </div>
                    </div>
                </div>        
                <div class="row">
                    <div class="col-lg-6">
						<label class="form-control-label">Testimonial Image <span style="color:red; font-weight:900; font-size:20px;">*</span></label><br><br>
                        {!! Form::file('testimonial_image', array('class' => 'image', 'data-validation'=>'[NOTEMPTY]' ,'data-validation-message'=>'Testimonial Image must not be empty!')) !!}
                    ...
                    <div class="col-lg-6">
						<label class="form-control-label">Testimonial Video</label>
                          <input class="form-control"  placeholder="Please Enter Youtube url"   name="testimonial_video"  type="url" >
					</div>
                </div>
                <div class="row">
                     <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
						<label class="form-control-label">Testimonial Video File</label><br><br>
                         {!! Form::file('testimonial_video_file', array('class' => 'image')) !!}
					</div>
                </div>
