   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			@endif
            <div class="col-lg-12">
			 {!! Form::open(array('route' => 'category.store','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')) !!}
				<div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-categoryname">Category Name <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input id="validation-categoryname" class="form-control"  placeholder="Category Name"   name="category_name"  type="text" data-validation="[NOTEMPTY]" data-validation-message="Category Name must not be empty!">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <textarea class="summernote" type="text" id="contents"  name="content" placeholder="Write a Content" ></textarea>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <textarea class="form-control" rows="4" id="l5" name="meta_description" placeholder="Meta Description"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <label class="form-control-label">Banner Image <span style="color:red; font-weight:900; font-size:20px;">*</span></label><br><br>
                        {!! Form::file('banner_image', array('class' => 'image', 'data-validation'=>'[NOTEMPTY]','data-validation-message'=>'Banner Image must not be empty!')) !!}
                    </div>
