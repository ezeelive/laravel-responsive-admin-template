   ...
   <div class="card-header">
    ...
    <div class="card-body">
        <div class="row">
			...
			@endif
            <div class="col-lg-12">
			 {!! Form::open(array('route' => 'eventdate.store','method'=>'POST', 'id'=>'form-validation', 'name'=>'form-validation', 'enctype'=>'multipart/form-data')) !!}
				<div class="row">
                    <div class="col-lg-12">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker-only-init  display-inline-block mr-2 mb-2" placeholder="From Date"  name="from_date" data-validation="[NOTEMPTY]" data-validation-message="From Date must not be empty!"/>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label">From Time  <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input type="text"  class="form-control timepicker-init" name="from_time" placeholder="Form Time" data-validation="[NOTEMPTY]" data-validation-message="Form Time must not be empty!">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label for="validation-event">To Date  <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                             <input type="text" class="form-control datepicker-only-init  display-inline-block mr-2 mb-2" placeholder="To Date"  name="to_date" data-validation="[NOTEMPTY]" data-validation-message="To Date must not be empty!"/>
                        </div>
                    </div>
                     <div class="col-lg-6">
                        <div class="form-group">
                            <label class="form-control-label">To Time  <span style="color:red; font-weight:900; font-size:20px;">*</span></label>
                            <input type="text"  class="form-control timepicker-init" name="to_time" placeholder="To Time" data-validation="[NOTEMPTY]" data-validation-message="To Time must not be empty!">
